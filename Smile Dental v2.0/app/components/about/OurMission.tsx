    ...
    <section className="my-16" id="mission">
      <div className="mx-auto w-full max-w-[1400px] px-5 py-16 md:px-10 md:py-12 lg:py-16">
        <h2 className="mb-8 text-3xl font-bold md:text-5xl lg:mb-14">
          Meet Smile Dental Care: Where Smiles Shine Brighter
        </h2>
        <p className="mb-8  text-sm text-slate-800 sm:text-base lg:mb-24 ">
          ...
          actually pleasant? Welcome to Smile Dental Care, your friendly
          neighborhood dental haven! We're here to change the way you think
          about going to the dentist - with gentle expertise, modern technology,
          and a focus on your comfort every step of the way.
        </p>
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-12">
          ...
          <div className="flex flex-col gap-5 rounded-2xl border border-solid border-black p-10 sm:p-20">
            ...
            <p className="text-sm text-slate-800 sm:text-base ">
              At Smile Dental Care, our mission is to provide exceptional dental
              care in a comfortable and friendly environment. We are committed
              to empowering our patients through education about oral health,
